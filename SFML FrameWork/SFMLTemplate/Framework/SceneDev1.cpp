...
void SceneDev1::Enter()
{
	...
	SOUNDBUFFER_MGR.Load("sound/death.wav");
	SOUNDBUFFER_MGR.Load("sound/out_of_time.wav");
...
void SceneDev1::OnChop(Sides side)
{
	...
	std::cout << "Player side: " << (int)player->GetSide() << ", Branch side: " << (int)branchSide << std::endl;
